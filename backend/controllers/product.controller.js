...
export const getFeaturedProducts = async (req, res) => {
    try {
        ...
        // if not in cache, i.e, redis, fetch from database
        // .lean() return plain JS object instead of Mongooose document which is better for performance
...
export const deleteProduct = async (req, res) => {
    try {
        ...
        if(product.image) {
            const publicId = product.image.split("/").pop().split(".")[0]; // this will extract the public ID from the URL
            try {
